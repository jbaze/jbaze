...
**SaaS platforms** with multi-tenant architecture, role-based access, and payment integration. Most of my recent projects are business tools where the complexity is in the workflows and data modeling, not the UI.

**AI-powered applications** integrating Claude and OpenAI APIs. Document ingestion, RAG pipelines, structured output generation, token management, and cost optimization.

**Dashboards and data visualization** with real-time updates, interactive maps, and complex filtering.
...
Databases:  PostgreSQL, MS SQL, MariaDB, MySQL
ORMs:       Entity Framework Core, Prisma
Messaging:  RabbitMQ, SignalR, WebSockets, Redis
Search:     Elasticsearch
Payments:   Stripe (including Connect), PayPal, BlueSnap
DevOps:     Docker, AWS, Azure, Nginx, GitHub Actions
AI:         Claude API, OpenAI API
Testing:    xUnit, NUnit, Jest, Jasmine/Karma
```
...
Buyers and sellers transacting through the platform. Stripe payments with vendor payouts, platform fees, escrow flows, and dispute handling.
...
I use **Claude Code** as my primary development tool daily. Also use **Lovable.dev** for rapid MVP prototyping and **Cursor** for certain tasks. AI-assisted development is part of my standard workflow, not an experiment.
